            ...
            <script>
                $(document).ready(function() {
                    $('.cluster-cell').each(function() {
                        ...
                        var purchaseFrequency = $(this).data('purchase-frequency');
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                var clusterName = data.clusters[0] == 0 ? 'Regular' : 'Irregular';
                    ...
                    // Wait for AJAX calls to complete before rendering the chart
                    setTimeout(function() {
